...
def parse_args() -> argparse.Namespace:
    ...
    # paths ---------------------------------------------------------------
    p.add_argument("--exp-dir", type=pathlib.Path, default="exps")
    ...
    p.add_argument("--max-updates", type=int, default=400_000)
    p.add_argument("--warmup-updates", type=int, default=32_000)
