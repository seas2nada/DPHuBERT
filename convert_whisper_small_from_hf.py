...
if __name__ == "__main__":
    out_name = "pretrained/whisper-small.hf.pth"

    config = AutoConfig.from_pretrained("openai/whisper-small")

    imported = WhisperForConditionalGeneration.from_pretrained("openai/whisper-small")
    print(imported)
    ...
    whisper_large_config = dict(
        ...
        encoder_layers=12,
        decoder_layers=12,
        decoder_ffn_dim=[3072] * 12,
        encoder_ffn_dim=[3072] * 12,
        ...
        conv_in_channels=[128, 768],
        conv_out_channels=[768, 768],
        encoder_attention_heads=[12] * 12,
        decoder_attention_heads=[12] * 12,
        cross_attention_heads=[12] * 12,
