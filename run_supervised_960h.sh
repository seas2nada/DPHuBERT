...
warmup=30000            # warmup steps
max=150000               # max update steps
...
sparsity_warmup=15000    # warmup steps for sparsity; sparsity will linearly increase from 0 to target
root_dir=exp/wav2vec2-base_train960_sp${target_sparsity}_spup${sparsity_warmup}_lr${lr}_up${warmup}_max${max}_${distill_mode}${distill_layers}_reglr${reg_lr}_${pruning_units}_ctc${ctc_weight}_mask${mask_prob}_chanmask${mask_channel_prob}
...
root_dir=exp/w2v2large_libri960_dp
